...
Since the algo is an API, you trigger it by sending a `POST` request. To check positions and execute trades every 5 minutes during market hours, use the following configuration.

**Market Hours (IST)**: 09:15 AM to 03:30 PM
**UTC Equivalent**: 03:45 AM to 10:00 AM
...
# Handle the 03:50-04:00 gap and 10:00 boundary if needed
